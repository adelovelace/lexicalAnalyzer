...
_lr_productions = [
  ...
  ('instrucciones -> operacion_aritmetica1','instrucciones',1,'p_instrucciones','clojure_sin.py',8),
  ('instrucciones -> condicional','instrucciones',1,'p_instrucciones','clojure_sin.py',9),
  ('instrucciones -> conjuntos','instrucciones',1,'p_instrucciones','clojure_sin.py',10),
  ('instrucciones -> vector_entero','instrucciones',1,'p_instrucciones','clojure_sin.py',11),
  ('instrucciones -> vector_flotante','instrucciones',1,'p_instrucciones','clojure_sin.py',12),
  ('instrucciones -> mapa_entero','instrucciones',1,'p_instrucciones','clojure_sin.py',13),
  ('instrucciones -> mapa_flotante','instrucciones',1,'p_instrucciones','clojure_sin.py',14),
  ('instrucciones -> if','instrucciones',1,'p_instrucciones','clojure_sin.py',15),
  ('instrucciones -> if_do','instrucciones',1,'p_instrucciones','clojure_sin.py',16),
  ...
  ('instrucciones -> definition','instrucciones',1,'p_instrucciones','clojure_sin.py',27),
  ('dato -> STRING','dato',1,'p_tipos_datos','clojure_sin.py',31),
  ('dato -> CHAR','dato',1,'p_tipos_datos','clojure_sin.py',32),
  ('dato -> ENTERO','dato',1,'p_tipos_datos','clojure_sin.py',33),
  ('dato -> FLOTANTE','dato',1,'p_tipos_datos','clojure_sin.py',34),
  ('dato -> BOOLEAN','dato',1,'p_tipos_datos','clojure_sin.py',35),
  ('dato -> VARIABLE','dato',1,'p_tipos_datos','clojure_sin.py',36),
  ('valor -> ENTERO','valor',1,'p_valor','clojure_sin.py',40),
  ('valor -> FLOTANTE','valor',1,'p_valor','clojure_sin.py',41),
  ('valor -> BOOLEAN','valor',1,'p_valor','clojure_sin.py',42),
  ('operador_comparadores -> COMPARA_IGUAL','operador_comparadores',1,'p_operadoresComparadores','clojure_sin.py',47),
  ('operador_comparadores -> MENORQUE','operador_comparadores',1,'p_operadoresComparadores','clojure_sin.py',48),
  ('operador_comparadores -> MAYORQUE','operador_comparadores',1,'p_operadoresComparadores','clojure_sin.py',49),
  ('operador_comparadores -> MAYORIGUALQUE','operador_comparadores',1,'p_operadoresComparadores','clojure_sin.py',50),
  ('operador_comparadores -> MENORIGUALQUE','operador_comparadores',1,'p_operadoresComparadores','clojure_sin.py',51),
  ('operador_comparadores -> DIFERENTE','operador_comparadores',1,'p_operadoresComparadores','clojure_sin.py',52),
  ('asignacion -> LPAREN DEFICION VARIABLE dato RPAREN','asignacion',5,'p_asignacion','clojure_sin.py',56),
  ('asignacion -> LPAREN LET LCOR VARIABLE dato RCOR RPAREN','asignacion',7,'p_asignacion','clojure_sin.py',57),
  ('sentencia_booleana -> LPAREN operador_comparadores dato dato RPAREN','sentencia_booleana',5,'p_sentenciaBooleana','clojure_sin.py',65),
  ('linecondition -> sentencia_booleana impresion','linecondition',2,'p_linecondition','clojure_sin.py',69),
  ('cond_ -> LPAREN COND linecondition linecondition RPAREN','cond_',5,'p_cond','clojure_sin.py',76),
  ('cond_else -> LPAREN COND linecondition linecondition DOSPUNTOS ELSE impresion RPAREN','cond_else',8,'p_condElse','clojure_sin.py',81),
  ('case -> dato impresion','case',2,'p_case','clojure_sin.py',85),
  ('case -> dato dato STRING','case',3,'p_case','clojure_sin.py',86),
  ('case_else -> DOSPUNTOS ELSE STRING','case_else',3,'p_case_else','clojure_sin.py',89),
  ('case_expression -> LPAREN CASE dato case case impresion RPAREN','case_expression',7,'p_case_expression','clojure_sin.py',92),
  ('case_expression -> LPAREN CASE dato case case case_else RPAREN','case_expression',7,'p_case_expression','clojure_sin.py',93),
  ('lista -> LPAREN LIST dato dato RPAREN','lista',5,'p_lista','clojure_sin.py',98),
  ('description -> STRING','description',1,'p_description','clojure_sin.py',106),
  ('increase -> INCREASE LCOR dato RCOR','increase',4,'p_increase','clojure_sin.py',109),
  ('argumments -> LCOR dato dato dato RCOR','argumments',5,'p_argumments','clojure_sin.py',112),
  ('argumments -> LCOR dato dato RCOR','argumments',4,'p_argumments','clojure_sin.py',113),
  ('argumments -> LCOR dato RCOR','argumments',3,'p_argumments','clojure_sin.py',114),
  ('body -> instrucciones','body',1,'p_body','clojure_sin.py',116),
  ('recur -> LPAREN RECUR LPAREN INC dato RPAREN RPAREN','recur',7,'p_recur','clojure_sin.py',119),
  ('internos -> description','internos',1,'p_internos','clojure_sin.py',123),
  ('internos -> argumments','internos',1,'p_internos','clojure_sin.py',124),
  ('internos -> body','internos',1,'p_internos','clojure_sin.py',125),
  ('internos -> increase','internos',1,'p_internos','clojure_sin.py',126),
  ('internos -> argumments body','internos',2,'p_internos','clojure_sin.py',127),
  ('internos -> description argumments body','internos',3,'p_internos','clojure_sin.py',128),
  ('definition -> LPAREN DEFFUNCION VARIABLE internos RPAREN','definition',5,'p_function','clojure_sin.py',132),
  ('definition -> LPAREN DEFFUNCION internos if dato RPAREN','definition',6,'p_function','clojure_sin.py',133),
  ('impresion -> LPAREN IMPRIMIR dato RPAREN','impresion',4,'p_impresion','clojure_sin.py',138),
  ('valor -> VARIABLE','valor',1,'p_valor_variable','clojure_sin.py',141),
  ('vector_entero -> VECTOR_ENTERO','vector_entero',1,'p_vector_entero','clojure_sin.py',145),
  ('vector_flotante -> VECTOR_FLOTANTE','vector_flotante',1,'p_vector_flotante','clojure_sin.py',148),
  ('mapa_entero -> MAPA_ENTERO','mapa_entero',1,'p_mapa_entero','clojure_sin.py',151),
  ('mapa_flotante -> MAPA_FLOTANTE','mapa_flotante',1,'p_mapa_flotante','clojure_sin.py',154),
  ('if -> IF LPAREN operador_comparadores dato dato RPAREN','if',6,'p_if','clojure_sin.py',157),
  ('if -> IF sentencia_booleana','if',2,'p_if','clojure_sin.py',158),
  ('if -> IF sentencia_booleana recur','if',3,'p_if','clojure_sin.py',159),
  ('if_do -> LPAREN IF LPAREN operador_comparadores dato dato RPAREN LPAREN DO LPAREN dato RPAREN BOOLEAN RPAREN RPAREN','if_do',15,'p_if_do','clojure_sin.py',166),
  ('operacion -> MAS','operacion',1,'p_op_aritmetica1','clojure_sin.py',172),
  ('operacion -> MENOS','operacion',1,'p_op_aritmetica1','clojure_sin.py',173),
  ('operacion -> PRODUCTO','operacion',1,'p_op_aritmetica1','clojure_sin.py',174),
  ('operacion -> DIVISION','operacion',1,'p_op_aritmetica1','clojure_sin.py',175),
  ('operacionesLogicas -> LPAREN IF LPAREN MENORQUE VARIABLE ENTERO RPAREN LPAREN RECUR LPAREN INC LPAREN VARIABLE RPAREN RPAREN VARIABLE RPAREN RPAREN','operacionesLogicas',18,'p_operacionesLogicas','clojure_sin.py',180),
  ('operacion_aritmetica1 -> LPAREN operacion valor valor RPAREN','operacion_aritmetica1',5,'p_operacion_aritmetica1','clojure_sin.py',184),
  ('condicional -> LPAREN operacion valor valor RPAREN','condicional',5,'p_booleanos','clojure_sin.py',187),
  ('doseq_args -> LCOR dato LPAREN RANGE dato RPAREN RCOR','doseq_args',7,'p_doseq_args','clojure_sin.py',192),
  ('doseq_args -> LCOR dato conjuntos RCOR','doseq_args',4,'p_doseq_args','clojure_sin.py',193),
  ('doseq_args -> LCOR dato vector_entero dato vector_entero RCOR','doseq_args',6,'p_doseq_args','clojure_sin.py',194),
  ('doseq_args -> LCOR vector_entero conjuntos RCOR','doseq_args',4,'p_doseq_args','clojure_sin.py',195),
  ('doseq_prn -> PRN LPAREN dato RPAREN','doseq_prn',4,'p_doseq_prn','clojure_sin.py',200),
  ('doseq_prn -> PRN LPAREN dato dato RPAREN','doseq_prn',5,'p_doseq_prn','clojure_sin.py',201),
  ('doseq_prn -> PRN LPAREN dato dato dato RPAREN','doseq_prn',6,'p_doseq_prn','clojure_sin.py',202),
  ('doseq -> LPAREN DOSEQ doseq_args LPAREN impresion RPAREN RPAREN','doseq',7,'p_doseq','clojure_sin.py',206),
  ('doseq -> LPAREN DOSEQ doseq_args LPAREN doseq_prn RPAREN RPAREN','doseq',7,'p_doseq','clojure_sin.py',207),
  ('defn -> LPAREN DEFFUNCION VARIABLE LCOR VARIABLE RCOR LPAREN expresionDefnElse RPAREN RPAREN','defn',10,'p_defn','clojure_sin.py',212),
  ('defn -> LPAREN DEFFUNCION INCREASE LCOR VARIABLE RCOR operacionesLogicas RPAREN','defn',8,'p_defn','clojure_sin.py',213),
  ('defn_with_return -> LPAREN DEFFUNCION VARIABLE LCOR VARIABLE RCOR LPAREN expresionDefnElse RPAREN RPAREN defn_return','defn_with_return',11,'p_defn_with_return','clojure_sin.py',218),
  ('defn_with_return -> LPAREN DEFFUNCION INCREASE LCOR VARIABLE RCOR operacionesLogicas RPAREN defn_return','defn_with_return',9,'p_defn_with_return','clojure_sin.py',219),
  ('expresionDefnElse -> CASE VARIABLE expresionCase DOSPUNTOS ELSE STRING','expresionDefnElse',6,'p_expresionDefnElse','clojure_sin.py',224),
  ('defn_return -> LPAREN dato dato RPAREN','defn_return',4,'p_defn_return','clojure_sin.py',228),
  ('expresionCase -> dato STRING','expresionCase',2,'p_expresionCase','clojure_sin.py',231),
  ('conjuntos -> NUMERAL L_LLAVE expresionConjuntoEnteros R_LLAVE','conjuntos',4,'p_conjuntos','clojure_sin.py',234),
  ('conjuntos -> NUMERAL L_LLAVE expresionConjuntoDouble R_LLAVE','conjuntos',4,'p_conjuntos','clojure_sin.py',235),
  ('conjuntos -> NUMERAL L_LLAVE expresionConjuntoString R_LLAVE','conjuntos',4,'p_conjuntos','clojure_sin.py',236),
  ('sentenciaLoopRecur -> LPAREN LOOP argumments LPAREN if dato RPAREN RPAREN','sentenciaLoopRecur',8,'p_sentenciaLoopRecur','clojure_sin.py',249),
  ('expresionConjuntoEnteros -> ENTERO','expresionConjuntoEnteros',1,'p_expresionConjuntoEnteros','clojure_sin.py',254),
  ('expresionConjuntoEnteros -> ENTERO expresionConjuntoEnteros','expresionConjuntoEnteros',2,'p_expresionConjuntoEnteros','clojure_sin.py',255),
  ('expresionConjuntoDouble -> FLOTANTE','expresionConjuntoDouble',1,'p_expresionConjuntoDouble','clojure_sin.py',259),
  ('expresionConjuntoDouble -> FLOTANTE expresionConjuntoDouble','expresionConjuntoDouble',2,'p_expresionConjuntoDouble','clojure_sin.py',260),
  ('expresionConjuntoString -> STRING','expresionConjuntoString',1,'p_expresionConjuntoString','clojure_sin.py',264),
  ('expresionConjuntoString -> STRING expresionConjuntoString','expresionConjuntoString',2,'p_expresionConjuntoString','clojure_sin.py',265),
]
